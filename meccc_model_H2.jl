...
H2_model[!, :H2] = twopart_concentration_profile.(2.5E-6, 1E-9, 1, 5, H2_model[!, :Depth])
H2_model[!, :H2_µM] = H2_model[!, :H2] * 1E6
H2_model[!, :Q] = H2_model[!, :H2] ./ 2.5E-6
H2_model[!, :deltaG] = deltaG.(293, H2_model[!, :Q])
H2_model[!, :loss] = (H2_model[!, :Depth]) .* Gdrop_mm
H2_model[!, :netG] = H2_model[!, :deltaG] .+ H2_model[!, :loss]

conc_plot = plot(H2_model, x = :H2_µM, y = :Depth, 
    Geom.path(),
